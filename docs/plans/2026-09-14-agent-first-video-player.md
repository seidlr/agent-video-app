...
- [ ] Task 7: Boxes + EdgeTAM segmentation + tracking + mask overlay + manual box drawing
- [ ] Task 8: Analysis: scene detection, similar frames, Whisper transcript + search, object detection
